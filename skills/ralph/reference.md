...
> On-demand reference for the Ralph entrypoint. The contract and state flow
> that must survive compaction are in `SKILL.md`; this file contains the detailed
> mechanics and historical rationale.
